...
#define  EXEEPROM_MEM_MAX_BUFFER      (20)
...
#define  LCD_CUSTOM_CHAR_EN        (1)
#define  LCD_RW                   (GPIO_A4)
#define  LCD_RS                   (GPIO_F6)
#define  LCD_EN                   (GPIO_F7)
#define  LCD_D4                   (GPIO_A3)
#define  LCD_D5                   (GPIO_A0)
#define  LCD_D6                   (GPIO_A2)
#define  LCD_D7                   (GPIO_A1)
#define  LCD_BL                   (GPIO_A5) 
#endif
...
/***********************ROW Pins********************/
#define KEYPAD_C01_PIN                  GPIO_E6
#define KEYPAD_C02_PIN                  GPIO_E7
#define KEYPAD_C03_PIN                  GPIO_B0
#define KEYPAD_C04_PIN                  GPIO_B2
/***********************Clomuns Pins********************/
#define KEYPAD_SW01_PIN                 GPIO_E2 /*E5*/
#define KEYPAD_SW02_PIN                 GPIO_E3  /*E4*/
#define KEYPAD_SW03_PIN                 GPIO_E4 /*E3*/
#define KEYPAD_SW04_PIN                 GPIO_E5 /*E2*/
#endif
/* 
 -------------------------------------------------------------------------------------------------
 |                          < DS1307 MODULE >                                                    |                                             
